function Login(){
    return(
        <div className="flex w-full h-full justify-center items-center bg-[url(./src/img/width_800.jpeg)] bg-cover">
            <div className="flex flex-col justify-center items-center w-1/3 h-1/2 bg-white/40 rounded-md">
                <div className="flex flex-row">
                    <div className="flex flex-col">
                        <img src="./src/img/ajl_logo.png" alt="" className="w-36 h-36" />
                        <div className="flex flex-col">
                            <div>
                                <p className="text-[#5b3011]">Login</p>
                                <input type="text" className="bg-[#9f6d3d]/19 rounded-md h-8 w-60"/>
                            </div>
                            <div>
                                <p className="text-[#5b3011]">Senha</p>
                                <input 
                                    type="text" 
                                    className="bg-[#9f6d3d]/19 rounded-md h-8 w-60" 
